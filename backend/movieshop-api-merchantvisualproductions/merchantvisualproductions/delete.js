...
module.exports.delete = async (event, context, callback) => {
  ...
  try {
    ...
    console.log("22222");
    const instance = `/merchants/${event.pathParameters.id}/merchantvisualproduction/${event.pathParameters.idMerchantVisualProduction}`;
    console.log("3333");
      ...
      if (result.Item.visualproductions.length === 1){
        ...
        try{
          ...
          return;
            ...
            const error_lam = await getError("en", "insert_generic_merchantvisualproduction_error",400,instance);
            callback(null, error_lam);
        }
      }
    }
