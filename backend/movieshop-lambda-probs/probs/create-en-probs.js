...
module.exports.create = (event, context, callback) => {
    ...
    var pwErroVisualProductionAlreadyExistBaseDeDados = {id: "en_visualproduction_not_exists_error", type: "https://ot5a2rcbb3.execute-api.eu-central-1.amazonaws.com/movieshop-nl-dev/probs/en_visualproduction_not_exists_error", title: "Error trying to insert visual production already exists on database",detail: "Impossible to insert visual production already exists on database, please try later or contact administrator",language: "en"};
    loginMessages.push(pwErroVisualProductionAlreadyExistBaseDeDados);  
